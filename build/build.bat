...
CALL "%JAVA_HOME%/bin/javac" -source 1.10 -target 1.10 -d "%ROOT_DIR%/obj" -cp "%PLATFORM_DIR%/android.jar" -sourcepath "%ROOT_DIR%/src" "%ROOT_DIR%/src/%PACKAGE_PATH%/MainActivity.java" "%ROOT_DIR%/src/%PACKAGE_PATH%/R.java"

@REM Convert to DEX.
CALL %BUILD_TOOLS_DIR%/d8.bat --min-api 34 --release --output %ROOT_DIR%/bin %ROOT_DIR%/obj/com/gilgamesh/xenagogy/MainActivity.class %ROOT_DIR%/obj/com/gilgamesh/xenagogy/R.class
